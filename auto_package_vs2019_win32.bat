...
devenv CxxPluginFramework.sln /Rebuild "Debug|Win32" /Project "ALL_BUILD.vcxproj"
devenv CxxPluginFramework.sln /Rebuild "Release|Win32" /Project "ALL_BUILD.vcxproj"
